    ...
    return (
        <form className="flex flex-col justify-center p-4 sm:p-14" onSubmit={handleSubmit} ref={ref} id="form">
            ...
            <div className="flex justify-center">
                <button
                    type="submit"
                    className="text-white  bg-sky-900 hover:bg-sky-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm  sm:w-auto px-5 py-2.5 text-center "
                >
                    Enviar solicitação
                </button>
            </div>
